...
FlowRouter.route('/ver-curso-all/:sigla',{
  name: 'ver_curso',
  action:function(params){
    if(Meteor.userId()){
        BlazeLayout.render('main_principal',{main:'ver_cursoMasterAll'})
      }else{
        FlowRouter.go('login')
      }
  }
...
FlowRouter.route('/pregunta-curso/:_id',{
  name: 'preguntasCurso',
  action:function(params){
    if(Meteor.userId()){
     // console.log(params)
      BlazeLayout.render('main_principal',{main:'preguntas_curso'}) 
      }else{
        FlowRouter.go('login')
      }
  }
...
FlowRouter.route('/responder-pregunta-curso/:_id',{
  name: 'responderPreguntacurso',
  action:function(params){ 
    if(Meteor.userId()){
     // console.log(params)
      BlazeLayout.render('main_principal',{main:'respuestas_pregunta_curso'})
      }else{
        FlowRouter.go('login')
      }
  }
